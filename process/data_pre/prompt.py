prompt = """
###Task###
You are an expert in the field of Re-Identification (ReID). The existing description of the image is {caption}. Please refer to the following requirements to understand the general and specific features of the image, and then combine all the features to return a descriptive language.
###Requirement###
